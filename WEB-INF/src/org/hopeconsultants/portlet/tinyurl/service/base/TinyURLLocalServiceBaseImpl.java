...
import org.hopeconsultants.portlet.tinyurl.service.TinyURLLocalService;
import org.hopeconsultants.portlet.tinyurl.service.persistence.TinyURLPersistence;
...
/**
 * Provides the base implementation for the tiny u r l local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.hopeconsultants.portlet.tinyurl.service.impl.TinyURLLocalServiceImpl}.
 * </p>
 *
...
public abstract class TinyURLLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements TinyURLLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.hopeconsultants.portlet.tinyurl.service.TinyURLLocalServiceUtil} to access the tiny u r l local service.
	 */
	...
	@Override
	public TinyURL addTinyURL(TinyURL tinyURL) throws SystemException {
		tinyURL.setNew(true);
	...
	@Override
	public TinyURL deleteTinyURL(long tinyURLId)
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TinyURL deleteTinyURL(TinyURL tinyURL) throws SystemException {
	...
	@Override
	public TinyURL fetchTinyURL(long tinyURLId) throws SystemException {
	 ...
	 */
	@Override
	public TinyURL getTinyURL(long tinyURLId)
		throws PortalException, SystemException {
	 ...
	 */
	@Override
	public int getTinyURLsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TinyURL updateTinyURL(TinyURL tinyURL) throws SystemException {
		return tinyURLPersistence.update(tinyURL);
	}

	/**
	 * Returns the tiny u r l local service.
	 *
	 * @return the tiny u r l local service
	 */
	public org.hopeconsultants.portlet.tinyurl.service.TinyURLLocalService getTinyURLLocalService() {
		return tinyURLLocalService;
	}

	/**
	 * Sets the tiny u r l local service.
	 *
	 * @param tinyURLLocalService the tiny u r l local service
	 */
	public void setTinyURLLocalService(
		org.hopeconsultants.portlet.tinyurl.service.TinyURLLocalService tinyURLLocalService) {
		this.tinyURLLocalService = tinyURLLocalService;
	}

	/**
	 * Returns the tiny u r l persistence.
	 *
	 * @return the tiny u r l persistence
	 */
	...
	/**
	 * Sets the tiny u r l persistence.
	 *
	 * @param tinyURLPersistence the tiny u r l persistence
	 */
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.hopeconsultants.portlet.tinyurl.model.TinyURL",
			tinyURLLocalService);
	}
	...
	@BeanReference(type = org.hopeconsultants.portlet.tinyurl.service.TinyURLLocalService.class)
	protected org.hopeconsultants.portlet.tinyurl.service.TinyURLLocalService tinyURLLocalService;
	...
	private TinyURLLocalServiceClpInvoker _clpInvoker = new TinyURLLocalServiceClpInvoker();
}